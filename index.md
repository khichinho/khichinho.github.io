...
| Generative AI | **LangChain, RAG, MCP Server, Vector DB**, Hugging Face, Prompt Engineering |
| Backend & Data | **FastAPI, Node.js, RDBMS (PostgreSQL), NoSQL (Couchbase)**, Express.js, Swagger, Spark |
| Frontend | **ReactJS, Angular**, MaterialUI, HTML/CSS, Plotly, Axios/Formik |
...
* Engineered a distributed, high-performance execution engine utilizing **NATS** and **Zarr** data-chunking to parallelize DNN explainability tests for **Self-Driving (Autonomous Vehicles) and ADAS systems**  
  → Enabled processing of **up to 1 terabyte (TB)** sensor datasets across optimized Kubernetes pods
...
* Engineered a full-stack ML recommendation engine for Agile tools (Rally/Jira) using **Python (Flask, Scikit-Learn)** and **React/Redux**, backed by **Java (Flux/Mono)** data pipelines  
...
* **Collaborative Research:** Partnered with **AIIMS Delhi** to validate model efficacy on real-world datasets  
  → Secured **HRD Ministry funding** via this high-impact collaboration
...
* **Talent & Hiring Strategy** — Conducting technical interviews for **India & Barcelona** R&D centers; defining evaluation rubrics for **Senior SDE & Architect** roles.
* **Mentorship** — Guiding **4 SDE Interns** through full project lifecycles, driving code quality standards and architectural reviews.
* **Strategic Engineering Lead** — Serving as the Acting Lead for a distributed **Automotive R&D team** comprising a majority of **German engineers** alongside a core **India-based team**; authoring the **Technical Roadmap (30+ pages)** to define strategic milestones.
* **Orchestrating JIRA sprint planning** and backlog grooming to align Product Management goals with engineering execution across global time zones.
* **Technical Enablement** — Fostering a culture of continuous learning by conducting internal workshops and training sessions on **RASA NLU, Cryptography, and Full Stack Development** to upskill peer engineers.
